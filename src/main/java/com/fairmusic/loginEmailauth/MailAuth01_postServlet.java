...
//@WebServlet(name="mailauth01", urlPatterns={"/mailauth01.do"})
public class MailAuth01_postServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		MailAuth01_postServlet mail = new MailAuth01_postServlet();

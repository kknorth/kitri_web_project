...
<div class="row">
  ...
  <div class="row">
    <div class="col-lg-5"><span class="label label-info">곡 명</span></div>
    <div class="col-lg-1"><span class="label label-info">가격</span></div>
    <div class="col-lg-3"><span class="label label-info">상세페이지로 이동</span></div>
